...
let separ = CONFIG.PLAYGROUND.wall_grid_separation;

// Objects to update reference
var wall1Front, wall1Back, wall1shadow, wall2Front, wall2Back, wall2shadow, wall1Light, wall2Light, wall1CameraHelper,
    wall2CameraHelper;
...
export function initWorld() {
    ...
    let wallFrontMaterial = new THREE.MeshBasicMaterial({
        map: loader.load('assets/textures/wall.bmp'),
        side: THREE.FrontSide
    });
    let wallBackMaterial = new THREE.MeshBasicMaterial({
        map: loader.load('assets/textures/wall.bmp'),
        side: THREE.BackSide,
        transparent: true,
        opacity: 0.3
